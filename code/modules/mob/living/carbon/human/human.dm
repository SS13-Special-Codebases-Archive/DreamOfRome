...
/mob/living/carbon/human/Stat()
	...
	if(statpanel("Status"))
		if(iswarfare())
			//stat("[ROMANS] reinforcements:", SSwarfare.barbarians.left)
			//stat("[ROMANS] capture points:", SSwarfare.barbarians.points)
			//stat("[RED_TEAM] reinforcements:", SSwarfare.romans.left)
			//stat("[RED_TEAM] capture points:", SSwarfare.romans.points)


			if(warfare_faction == ROMANS)
				for(var/area/A in GLOB.roman_captured_zones)
					stat("Captured Trench:", A)
			if(warfare_faction == BARBARIANS)
