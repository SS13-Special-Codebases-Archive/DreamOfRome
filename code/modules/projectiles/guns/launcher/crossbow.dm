...
/obj/item/gun/launcher/crossbow/arcuballista
	name = "roman arcuballista"
	desc = "Standard issue crossbow of the Roman military. Packs a punch, but takes time to reload."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "crossbow"
	item_state = "crossbow-solid"
	fire_delay = 25

	max_tension = 5 //Test and tweak for balancing later
	release_speed = 5
	move_delay = 4 //Test this