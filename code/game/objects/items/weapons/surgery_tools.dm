...
//ROMAN
//redundant, but need to change the names and icons

/obj/item/scalpel/roman
	name = "iron scalpel"
	desc = "Used in incisions of the body. Make sure to use anesthetics! Or not."
	icon_state = "scalpel"

/obj/item/hemostat/roman
	name = "iron haemostat"
	desc = "Used for the control of bleeding, especially in arterial damage."
	icon_state = "hemostat"

/obj/item/retractor/roman //https://www.romanobritain.org/13_roman_medical/roman_surgery.php#BoneHooks
	name = "iron medical hook"
	desc = "Used to retract bodily tissues during surgery. This is gonna be painful."
	icon_state = "retractor"

/obj/item/suture/roman
	name = "surgical suture"
	icon_state = "suture"
	desc = "Used by the army surgeons to stitch up wounded arteries and other bodily tissue. The scars will be cool, I suppose."

/obj/item/surgicaldrill/roman
	name = "bone drill"
	desc = "Essential to extracting foreign objects from the bone or body."
	icon_state = "drill"

/obj/item/circular_saw/roman
	name = "iron bone saw"
	desc = "You will have to go through the bone if you do not want to get gangrene."
	icon_state = "saw3"

/obj/item/stack/medical/splint
	name = "medical splints"
	singular_name = "medical splint"
	desc = "Splints capable of supporting and immobilizing bones in both limbs and appendages."
	icon_state = "splint"