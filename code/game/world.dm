/var/server_name = "Dream of Rome"
/var/game_id = null
/var/list/warfare_taglines = list("The World Unfolding", "Babarians at the Gates", "Rome has Fallen")
...
/world/New()
	...
	warfare_tagline = "[pick(warfare_taglines)]"
