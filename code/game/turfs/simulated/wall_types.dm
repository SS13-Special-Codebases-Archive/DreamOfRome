...
/turf/simulated/wall/roman
	name = "castra wall"
	desc = "Roman-made walls, highly durable. They are a testament to Roman engineering."
	icon_state = "roman0"
	walltype = "roman"
	mineral = "rust"
	plane = ABOVE_HUMAN_PLANE
	integrity = 500 //aint sieging this shit

/turf/simulated/wall/stonebrick
	name = "stone wall"
	desc = "Typical wall constructed of stone. Sturdy, but not impervious."
