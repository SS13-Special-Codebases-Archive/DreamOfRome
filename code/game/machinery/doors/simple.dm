...
/obj/machinery/door/unpowered/simple/roman
	icon_base = "roman"

/obj/machinery/door/unpowered/simple/roman/New(var/newloc,var/material_name,var/complexity)
	..(newloc, "roman", complexity)